...
\begin{remark}
  ...
  morphism or Conjecture~$\mathbf{B} (X,n)$ is brought, we will tacitly assume
  this. This is quite unfortunate, because Weil-\'{e}tale cohomology was
  ...
  singular $X_{\red,\CC}$ is an interesting project for further work.
\end{remark}
...
finitely generated groups, trivial for $|i| \gg 0$
