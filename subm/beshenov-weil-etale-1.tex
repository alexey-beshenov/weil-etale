...
\begin{proposition}
  ...
  Let $X$ be an arithmetic scheme. Then $X (\CC)$ has the following kinds of
...
provided by (TR3).
% This is a notorious issue with the derived category formalism.
