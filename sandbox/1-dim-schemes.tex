...
all one-dimensional arithmetic schemes, not necessary abelian. This is
...
\begin{lemma}
  ...
  \begin{proof}
    ...
    from \cite[Proposition~5.35]{Flach-Morin-2018}. (The latter uses reduction to
    the Tamagawa number conjecture.) The formula is equivalent to
    \eqref{eqn:special-value-formula}, since $2^\delta = |H^1 (X_\et, \ZZ (n))|$
    by \eqref{eqn:2-torsion-in-H1-Zc-for-Spec-OF}.
  \end{proof}
\end{lemma}
...
\item \textbf{Step 2}. We consider a canonical morphism $i^*_\infty$ in the
  ...
  We refer to \cite[\S 7]{Beshenov-Weil-etale-1} for the general properies.
\end{itemize}
...
\begin{proof}
  ...
  convenient to do this without passng explicitly through
