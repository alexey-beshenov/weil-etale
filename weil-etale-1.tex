...
\S\ref{sec:consecuences-of-theorem-I}. Namely, if we assume the conjecture
$\mathbf{L}^c (X_\et, n)$, then our complexes have the following
type.
\begin{center}
  ...
  \begin{tabular}{cc}
    ...
    \hline
    $R\Gamma (X_\et, \ZZ^c (n))$ & perfect \\
    $R\widehat{\Gamma}_c (X_\et, \ZZ (n)) = R\widehat{\Gamma}_c (X_\et, \QQ/\ZZ (n)) [-1]$ & cofinite type \\
    $R\widehat\Gamma_c (X_\et, \ZZ (n)) = R\Gamma_c (X_\et, \QQ/\ZZ (n)) [-1]$ & almost cofinite type \\
    \hline
  \end{tabular}
\end{center}
For this we first make a little digression in
\S\ref{sec:GR-equivariant-cohomology} to analyze what kind of complexes
we obtain for $G_\RR$-equivariant cohomology on $X (\CC)$.
...
Then in \S\ref{sec:theorem-II} we establish Theorem~\ref{theorem-II},
and finally, it is used in \S\ref{sec:RGamma-Wc} to define Weil-étale complexes
...
\begin{center}
  ...
  \begin{tabular}{cc}
    ...
    \hline
    \begin{tabular}{c} Geisser's dualizing cycle complexes \\ $\ZZ^c (n)$ \end{tabular} & \begin{tabular}{c} Bloch's cycle complexes \\ $\ZZ (d-n)[2d]$, $d = \dim X$ \end{tabular} \\
    \hline
...
\section{Some consecuences of Theorem~I}
\label{sec:consecuences-of-theorem-I}
...
\begin{lemma}
  ...
  \begin{proof}
    ...
    duality theorem~\ref{theorem-I} gives
...
\begin{lemma}
  ...
  \begin{proof}
    ...
    perfect complex, and by Theorem~\ref{theorem-I} we have
    \[ R\widehat{\Gamma}_c (X_\et, \ZZ (n)) \cong
    \RHom (R\Gamma (X_\et, \ZZ^c (n)), \QQ/\ZZ [-2]), \]
