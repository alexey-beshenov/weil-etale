...
\section{Comparison with Weil-étale complex of Flach and Morin}
...
\begin{proposition}
  ...
  $R\Gamma_\Wc (X, \ZZ(n))$ defined in this paper is isomorphic to the
  corresponding complex defined in \cite{Flach-Morin-2018}.
\end{proposition}
