...
\begin{lemma}
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      H^0_c (G_\RR, U(\CC), \ZZ(n)) & \xrightarrow{\cong} H^0_c (G_\RR, X(\CC), \ZZ(n)).
    \end{align*}
...
\begin{definition}
  ...
  coming from $\Hom(H^0_c (G_\RR, X(\CC), \ZZ(n)), \ZZ)$.  
\end{definition}
...
\begin{example}
  ...
  obtained from $\Spec \ZZ [1/2]$ and $\AA^1_{\FF_p} = \Spec \FF_p [t]$ by
