...
\begin{remark}
  ...
  However, by \cite[Proposition~4.1]{Beshenov-Weil-etale-1}, the finite
...
\begin{example}
  ...
  fields \cite[Proposition~4.1]{Beshenov-Weil-etale-1}. Therefore, the
...
\begin{proposition}
  ...
  \begin{proof}
    ...
    (see \cite[Proposition~4.1]{Beshenov-Weil-etale-1}), and therefore by
