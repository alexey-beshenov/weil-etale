...
\begin{abstract}
  ...
  bundles, and as a consequence, that it holds if $X$ is a cellular scheme over
  a base which is a curve over a finite field $C/\FF_q$ or the spectrum of an
  $S$-order in an abelian number field $F/\QQ$.
